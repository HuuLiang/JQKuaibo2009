...
@implementation JQKPaymentPopView (Size)
...
+ (instancetype)sharedInstance {
    static JQKPaymentPopView *_sharedPaymentPopView;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedPaymentPopView = [[JQKPaymentPopView alloc] init];
    });
...
- (void)onAlipay {
    if (self.paymentAction) {
        self.paymentAction(JQKPaymentTypeAlipay);
    }
}

- (void)onWeChatPay {
    if (self.paymentAction) {
        self.paymentAction(JQKPaymentTypeWeChatPay);
    }
}

- (void)onUPPay {
    if (self.paymentAction) {
//        self.paymentAction(JQKPaymentTypeUPPay);
    }
}
